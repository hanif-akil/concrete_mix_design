...
#cft 
cft = 35.315
V_fa = cft *solve[0]/(Gfa*Yw) 
V_ca = cft *solve[1]/(Gca*Yw) 
V_c = cft *Wc/(Gc*Yw)

print(f"volume of Fine Aggregate {V_fa} cft")
print(f"volume of coarse Aggregate {V_ca} cft")
print(f"volume of Cement {V_c} cft")
